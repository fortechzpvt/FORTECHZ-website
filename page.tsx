...
const metrics = [
  ...
  { value: "100%",   label: "Clients who renewed or referred in 2026" },
];
  ...
  return (
    <main className="min-h-screen bg-canvas pt-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-px bg-ink/[0.07]">
          {founders.map((f, i) => (
            <a
              ...
              className="bg-canvas p-8 md:p-10 space-y-5 group anim-up block"
            ...
            >
              ...
              <div className="space-y-1">
                <h3 className="font-display font-bold text-ink text-lg md:text-xl tracking-[-0.04em] uppercase leading-tight group-hover:text-accent transition-colors duration-300">
                  {f.name}
                </h3>
      ...
      <section className="px-6 md:px-10 lg:px-16 py-16 border-b border-ink/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-ink/[0.07]">
          {metrics.map((m, i) => (
            <div
              key={m.label}
