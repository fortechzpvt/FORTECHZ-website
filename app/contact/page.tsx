    ...
    <main className="min-h-screen bg-canvas pt-14">
      ...
      <div className="px-6 md:px-10 lg:px-16 py-16 grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-5 space-y-10 anim-up" style={{ animationDelay: "0.18s" }}>
          ...
          <div className="space-y-3">
            <p className="font-mono text-xs tracking-[0.2em] text-ink/30 uppercase">Follow us</p>
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 border border-ink/15 hover:border-accent/50 hover:bg-accent/5 flex items-center justify-center transition-colors duration-200"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <rect x="2" y="2" width="20" height="20" rx="5" stroke="currentColor" strokeWidth="1.6" className="text-ink/60" />
                  <circle cx="12" cy="12" r="4.2" stroke="currentColor" strokeWidth="1.6" className="text-ink/60" />
                  <circle cx="17.4" cy="6.6" r="1.1" fill="currentColor" className="text-ink/60" />
                </svg>
              </a>
              <a
